  ...
  const chartData: ChartData<'line'> = {
    ...
    datasets: [
      ...
      // Gray line
      {
        ...
        borderColor: getCssVariable('--color-gray-500') ? adjustColorOpacity(getCssVariable('--color-gray-500'), 0.25) : '',
        borderWidth: 2,
        pointRadius: 0,
        pointHoverRadius: 3,
        pointBackgroundColor: getCssVariable('--color-gray-500') ? adjustColorOpacity(getCssVariable('--color-gray-500'), 0.25) : '',
        pointHoverBackgroundColor: getCssVariable('--color-gray-500') ? adjustColorOpacity(getCssVariable('--color-gray-500'), 0.25) : '',
        pointBorderWidth: 0,
        pointHoverBorderWidth: 0,
        clip: 20,
        tension: 0.2,
