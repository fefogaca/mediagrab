...
export default function ThemeToggle() {
  ...
  return (
    <div className="inline-flex">
      ...
      />
      <label
        className="relative flex items-center justify-center cursor-pointer w-8 h-8 hover:bg-gray-100 lg:hover:bg-gray-200 dark:hover:bg-gray-700/50 dark:lg:hover:bg-gray-800 rounded-full"
        htmlFor="light-switch"
      >
        {/* Sun icon */}
        <svg
          className="dark:hidden fill-current text-gray-900 dark:text-gray-400"
          width={16}
          height={16}
          viewBox="0 0 16 16"
        ...
        {/* Moon icon */}
        <svg
          className="hidden dark:block fill-current text-gray-400"
          width={16}
          height={16}
          viewBox="0 0 16 16"
          xmlns="http://www.w3.org/2000/svg"
