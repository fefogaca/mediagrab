...
export const chartAreaGradient = (ctx: CanvasRenderingContext2D, chartArea: ChartArea, colorStops: { stop: number; color: string }[]) => {
...
export const chartColors = {
  ...
  gridColor: {
    ...
    dark: getCssVariable('--color-gray-700') ? adjustColorOpacity(getCssVariable('--color-gray-700'), 0.6) : '',
  },
  backdropColor: {
