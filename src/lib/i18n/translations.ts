...
export const translations = {
  pt: {
    ...
    admin: {
      ...
      installations: {
        title: 'Instalações do Bot',
        subtitle: 'Rastreamento de instalações do MediaGrab Bot',
        errorLoading: 'Erro ao carregar instalações',
        searchPlaceholder: 'Buscar por número do bot ou desenvolvedor...',
        stats: {
          totalInstallations: 'Total de Instalações',
          installationsToday: 'Instalações Hoje',
          installationsThisWeek: 'Esta Semana',
          installationsThisMonth: 'Este Mês',
          uniqueDevelopers: 'Desenvolvedores Únicos',
          lastInstallation: 'Última Instalação',
        },
        table: {
          botPhone: 'Número do Bot',
          developerName: 'Desenvolvedor',
          developerPhone: 'Telefone Dev',
          installationDate: 'Data de Instalação',
          botName: 'Nome do Bot',
          version: 'Versão',
          actions: 'Ações',
          noInstallations: 'Nenhuma instalação encontrada',
          installationsFound: 'instalação(ões) encontrada(s)',
        },
        filters: {
          search: 'Buscar',
      ...
      settings: {
        ...
        stripe: {
          title: 'Stripe',
          subtitle: 'Configurações de pagamento com Stripe',
          enabled: 'Habilitar Stripe',
          enabledDesc: 'Ativa integração com Stripe para processar pagamentos',
          secretKey: 'Secret Key',
          secretKeyDesc: 'Chave secreta do Stripe (sk_...)',
          publishableKey: 'Publishable Key',
          publishableKeyDesc: 'Chave pública do Stripe (pk_...)',
          webhookSecret: 'Webhook Secret',
          webhookSecretDesc: 'Secret do webhook do Stripe (whsec_...)',
          developerPriceId: 'Developer Price ID',
          developerPriceIdDesc: 'ID do preço do plano Developer (price_...)',
          developerProductId: 'Developer Product ID',
          developerProductIdDesc: 'ID do produto Developer (prod_...)',
          startupPriceId: 'Startup Price ID',
          startupPriceIdDesc: 'ID do preço do plano Startup (price_...)',
          startupProductId: 'Startup Product ID',
          startupProductIdDesc: 'ID do produto Startup (prod_...)',
          enterprisePriceId: 'Enterprise Price ID',
          enterprisePriceIdDesc: 'ID do preço do plano Enterprise (price_...)',
          enterpriseProductId: 'Enterprise Product ID',
          enterpriseProductIdDesc: 'ID do produto Enterprise (prod_...)',
          testMode: 'Modo Teste',
          testModeDesc: 'Use chaves de teste do Stripe',
        },
        sendgrid: {
          title: 'SendGrid',
          subtitle: 'Configurações de envio de emails',
          enabled: 'Habilitar SendGrid',
          enabledDesc: 'Ativa integração com SendGrid para envio de emails',
          apiKey: 'API Key',
          apiKeyDesc: 'Chave de API do SendGrid',
          fromEmail: 'Email Remetente',
          fromEmailDesc: 'Email que aparecerá como remetente',
          testEmail: 'Testar Email',
          testEmailDesc: 'Enviar email de teste',
          sending: 'Enviando...',
          sent: 'Email de teste enviado!',
          error: 'Erro ao enviar email de teste',
        },
        googleOAuth: {
          title: 'Google OAuth',
          subtitle: 'Configurações de autenticação com Google',
          enabled: 'Habilitar Google OAuth',
          enabledDesc: 'Permite login com conta Google',
          clientId: 'Client ID',
          clientIdDesc: 'ID do cliente OAuth do Google',
          clientSecret: 'Client Secret',
          clientSecretDesc: 'Secret do cliente OAuth do Google',
        },
        githubOAuth: {
          title: 'GitHub OAuth',
          subtitle: 'Configurações de autenticação com GitHub',
          enabled: 'Habilitar GitHub OAuth',
          enabledDesc: 'Permite login com conta GitHub',
          clientId: 'Client ID',
          clientIdDesc: 'ID do cliente OAuth do GitHub',
          clientSecret: 'Client Secret',
          clientSecretDesc: 'Secret do cliente OAuth do GitHub',
        },
        cookies: {
          title: 'Cookies de Autenticação',
          subtitle: 'Upload de arquivos de cookies para Instagram e YouTube',
          instagram: 'Cookies do Instagram',
          instagramDesc: 'Faça upload do arquivo de cookies do Instagram (formato Netscape)',
          youtube: 'Cookies do YouTube',
          youtubeDesc: 'Faça upload do arquivo de cookies do YouTube (formato Netscape)',
          upload: 'Fazer Upload',
          uploading: 'Enviando...',
          success: 'Cookies atualizados com sucesso!',
          error: 'Erro ao fazer upload dos cookies',
          ...
          test: 'Testar',
          testing: 'Testando...',
          testSuccess: 'Cookies estão funcionando corretamente!',
          testError: 'Cookies podem estar expirados ou inválidos',
          testNoCookies: 'Nenhum cookie configurado',
        },
      },
    ...
    userDashboard: {
      ...
      notifications: {
        title: 'Notificações',
        subtitle: 'Suas notificações e avisos',
        noNotifications: 'Nenhuma notificação',
        markAsRead: 'Marcar como lida',
  ...
  en: {
    ...
    admin: {
      ...
      installations: {
        title: 'Bot Installations',
        subtitle: 'MediaGrab Bot installation tracking',
        errorLoading: 'Error loading installations',
        searchPlaceholder: 'Search by bot number or developer...',
        stats: {
          totalInstallations: 'Total Installations',
          installationsToday: 'Installations Today',
          installationsThisWeek: 'This Week',
          installationsThisMonth: 'This Month',
          uniqueDevelopers: 'Unique Developers',
          lastInstallation: 'Last Installation',
        },
        table: {
          botPhone: 'Bot Phone',
          developerName: 'Developer',
          developerPhone: 'Dev Phone',
          installationDate: 'Installation Date',
          botName: 'Bot Name',
          version: 'Version',
          actions: 'Actions',
          noInstallations: 'No installations found',
          installationsFound: 'installation(s) found',
        },
        filters: {
          search: 'Search',
          developer: 'Developer',
      ...
      settings: {
        ...
        stripe: {
          title: 'Stripe',
          subtitle: 'Stripe payment configuration',
          enabled: 'Enable Stripe',
          enabledDesc: 'Enable Stripe integration for payment processing',
          secretKey: 'Secret Key',
          secretKeyDesc: 'Stripe secret key (sk_...)',
          publishableKey: 'Publishable Key',
          publishableKeyDesc: 'Stripe publishable key (pk_...)',
          webhookSecret: 'Webhook Secret',
          webhookSecretDesc: 'Stripe webhook secret (whsec_...)',
          developerPriceId: 'Developer Price ID',
          developerPriceIdDesc: 'Developer plan price ID (price_...)',
          developerProductId: 'Developer Product ID',
          developerProductIdDesc: 'Developer product ID (prod_...)',
          startupPriceId: 'Startup Price ID',
          startupPriceIdDesc: 'Startup plan price ID (price_...)',
          startupProductId: 'Startup Product ID',
          startupProductIdDesc: 'Startup product ID (prod_...)',
          enterprisePriceId: 'Enterprise Price ID',
          enterprisePriceIdDesc: 'Enterprise plan price ID (price_...)',
          enterpriseProductId: 'Enterprise Product ID',
          enterpriseProductIdDesc: 'Enterprise product ID (prod_...)',
          testMode: 'Test Mode',
          testModeDesc: 'Use Stripe test keys',
        },
        sendgrid: {
          title: 'SendGrid',
          subtitle: 'Email sending configuration',
          enabled: 'Enable SendGrid',
          enabledDesc: 'Enable SendGrid integration for sending emails',
          apiKey: 'API Key',
          apiKeyDesc: 'SendGrid API key',
          fromEmail: 'From Email',
          fromEmailDesc: 'Email address that will appear as sender',
          testEmail: 'Test Email',
          testEmailDesc: 'Send test email',
          sending: 'Sending...',
        ...
        googleOAuth: {
          title: 'Google OAuth',
          subtitle: 'Google authentication configuration',
          enabled: 'Enable Google OAuth',
          enabledDesc: 'Allow login with Google account',
          clientId: 'Client ID',
          clientIdDesc: 'Google OAuth client ID',
          clientSecret: 'Client Secret',
          clientSecretDesc: 'Google OAuth client secret',
        },
        githubOAuth: {
          title: 'GitHub OAuth',
          subtitle: 'GitHub authentication configuration',
          enabled: 'Enable GitHub OAuth',
          enabledDesc: 'Allow login with GitHub account',
          clientId: 'Client ID',
          clientIdDesc: 'GitHub OAuth client ID',
          clientSecret: 'Client Secret',
          clientSecretDesc: 'GitHub OAuth client secret',
        },
        cookies: {
          title: 'Authentication Cookies',
          subtitle: 'Upload cookie files for Instagram and YouTube',
          instagram: 'Instagram Cookies',
          instagramDesc: 'Upload Instagram cookie file (Netscape format)',
          youtube: 'YouTube Cookies',
          youtubeDesc: 'Upload YouTube cookie file (Netscape format)',
          upload: 'Upload',
          uploading: 'Uploading...',
          success: 'Cookies updated successfully!',
          error: 'Error uploading cookies',
          ...
          test: 'Test',
          testing: 'Testing...',
          testSuccess: 'Cookies are working correctly!',
          testError: 'Cookies may be expired or invalid',
          testNoCookies: 'No cookies configured',
        },
      },
    ...
    userDashboard: {
      ...
      notifications: {
        ...
        unread: 'Unread',
        errorLoading: 'Error loading notifications',
        errorUpdating: 'Error updating notification',
